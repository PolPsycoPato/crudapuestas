...
export default class EditarJugadores extends Component {
  ...
  editarJugador = (e) => {
    ...
    let request =
      "/api/Jugadores/" +
      this.props.idjugadores +
      "/" +
      this.state.jugador.idEquipo;
          ...
          <form class="bg-white shadow-md rounded-lg p-6 w-full max-w-md space-y-4">
            ...
            <div>
              ...
              <input
                ...
                id="nombre"
                name="nombre"
                defaultValue={this.state.jugador.nombre}
            ...
            <div>
              <label for="imagen" class="block text-gray-700 font-medium mb-1">
                URL de Imagen
              </label>
              <input
                type="url"
            ...
            <div>
              ...
              <input
                ...
                defaultValue={this.state.jugador.fechaNacimiento}
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                ref={this.cajaFecha}
              />
            </div>
            ...
            <div>
              <label for="pais" class="block text-gray-700 font-medium mb-1">
                País
              </label>
              <input
                type="text"
                id="pais"
                name="pais"
                defaultValue={this.state.jugador.pais}
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                ref={this.cajaPais}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                id="idEquipo"
                name="idEquipo"
                defaultValue={this.state.jugador.idEquipo}
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
